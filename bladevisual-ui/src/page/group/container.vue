            ...
            initData() {
                ...
                if(id) {
                    ...
                    getObj(id).then(res => {
                        ...
                        if(data == null) {
                            this.$message.error('可视化详情不存在！')
                            loading.close();
                            document.getElementById("app").innerHTML = "";
                            //                          this.$refs.buildmain.innerHTML = ""
                            return false;
                        }
                        ...
                        if(!isBuild) {
                            ...
                            //                          }
                            let resConfig = JSON.parse(config.detail) || this.contain.config;

                            if(resConfig.mark.show) {
                                this.watermark(resConfig.mark);
                            }
