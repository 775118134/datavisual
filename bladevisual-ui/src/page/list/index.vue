<template>
    <el-container class="list">
        <el-header>
            <el-menu :default-active="activeName" mode="horizontal" @select="handleSelect" style="border-color:#051C31" background-color="#051F39" text-color="#fff" active-text-color="#00baff">
                <el-menu-item :index="item.categoryValue" :key="item.categoryValue" v-for="item in typelist" @click="getList(item.categoryValue)">
                    <i class="iconfont icon-daping"></i> {{item.categoryKey}}
                </el-menu-item>
            </el-menu>
        </el-header>
        ...
        <el-main>
            <div class="page">
                <el-pagination layout="total, sizes, prev, pager, next, jumper" background @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-size="page.size" :current-page.sync="page.page" :total="page.total">
                </el-pagination>
            </div>
            <div class="content">
                <div class="content__item content__item--add" @click="handleAdd">
                    <div>
        ...
        <el-dialog title="新建大屏" width="35%" :visible.sync="box">
            <avue-form :option="option" v-model="form" @submit="handleSave"></avue-form>
        </el-dialog>
    </el-container>
</template>
<script>
    import { addObj, copyObj, delObj, getList, updateObj } from '@/api/visual';
    import { getAllList as getCategory } from '@/api/category';
            ...
            return {
                ...
                option: {
                    column: [{
                        ...
                        labelWidth: 100,
                        type: 'select',
                        dicUrl: this.url + 'bladeVisualCategorys/list',
                        props: {
                            label: 'categoryKey',
                            value: 'categoryValue'
                        },
