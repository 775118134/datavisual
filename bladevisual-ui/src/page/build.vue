<template>
    <div class="build">
                ...
                <el-tabs class="tabs" stretch v-model="tabsActive">
                        ...
                        <el-form label-width="120px" label-position="left" size="mini">
                            ...
                            <template v-else>
                                ...
                                <el-form-item label="环境地址">
                                    <avue-input type="textarea" :min-rows="2" v-model="config.url"></avue-input>
                                </el-form-item>
                                <el-form-item label="参数">
                                    <el-button size="mini" type="primary" @click="openCode('query')">编辑</el-button>
                                </el-form-item>
                    ...
                    <el-tab-pane name="1" v-if="vaildProp('dataList')">
                        ...
                        <el-form label-width="120px" label-position="left" size="mini">
                            ...
                            <el-form-item label="数据值" label-position="top" v-if="activeObj.dataType===0">
                            ...
                            <template v-if="activeObj.dataType===1">
                                ...
                                <el-form-item label="接口参数" v-if="activeObj.dataType===1">
                                    <el-button size="mini" type="primary" @click="openCode('dataQuery')">编辑</el-button>
                                </el-form-item>
                            ...
                            <el-form-item label="数据处理">
                                <el-button size="mini" type="primary" @click="openCode('dataFormatter')">编辑</el-button>
                            </el-form-item>
                            <el-form-item label-width="0">
                                <el-button size="mini" type="primary" class="block" @click="handleRefresh">刷新</el-button>
                            </el-form-item>
                        </el-form>
        ...
        <el-dialog title="代码编辑" :visible.sync="code.box" @close="code.obj={}" width="60%">
            <codeedit ref="codeedit" v-model="code.obj"></codeedit>
            <span slot="footer" class="dialog-footer">
                <el-button size="small" @click="code.box=false">取 消</el-button>
                <el-button type="primary" @click="codeClose" size="small">确 定</el-button>
            </span>
        </el-dialog>
