...
<template>
    <div>
        <el-form-item label="表头颜色">
            <avue-color type="textarea" v-model="main.activeOption.headerColor"></avue-color>
        </el-form-item>
        <el-form-item label="表头背景">
            <avue-color type="textarea" v-model="main.activeOption.headerBackgroud"></avue-color>
        </el-form-item>
        ...
        <el-form-item label="文字颜色">
            <avue-color type="textarea" v-model="main.activeOption.bodyColor"></avue-color>
        </el-form-item>
        <el-form-item label="表格背景">
            <avue-color type="textarea" v-model="main.activeOption.bodyBackgroud"></avue-color>
        </el-form-item>
        <el-form-item label="字体位置">
        ...
        <el-form-item label="分割线">
            <avue-color type="textarea" v-model="main.activeOption.borderColor"></avue-color>
        </el-form-item>
        <el-form-item label="奇行颜色">
            <avue-color type="textarea" v-model="main.activeOption.nthColor"></avue-color>
        </el-form-item>
        <el-form-item label="偶行颜色">
            <avue-color type="textarea" v-model="main.activeOption.othColor"></avue-color>
        </el-form-item>
        <avue-crud :option="tableOption" :data="main.activeOption.column" @row-save="rowSave" @row-del="rowDel" @row-update="rowUpdate"></avue-crud>
    </div>
</template>
