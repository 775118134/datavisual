        ...
        <el-collapse accordion>
            ...
            <template v-if="main.vaildProp('titleList')">
                <el-collapse-item title="标题设置">
                    ...
                    <el-form-item label="字体位置">
                        <avue-select v-model="main.activeOption.titlePostion" :dic="dicOption.textAlign">
                        </avue-select>
                    </el-form-item>
            ...
            <template v-if="main.vaildProp('colorList')">
                <el-collapse-item title="自定义配色">
                    ...
                    <avue-crud :option="colorOption" :data="main.activeOption.barColor" @row-save="rowSave" @row-del="rowDel" @row-update="rowUpdate"></avue-crud>
                </el-collapse-item>
            </template>
        </el-collapse>
    </div>
