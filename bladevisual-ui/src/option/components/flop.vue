        ...
        <el-collapse accordion>
            <el-collapse-item title="边框设置">
                ...
                <el-form-item label="边框宽度">
                    <avue-input-number v-model="main.activeOption.width" :max="1000"></avue-input-number>
                </el-form-item>
                <el-form-item label="边框高度">
                    <avue-input-number v-model="main.activeOption.height" :max="1000"></avue-input-number>
                </el-form-item>
                ...
                <template v-if="main.activeOption.type==='img'">
                    <el-form-item label="图片地址">
                        <img v-if="main.activeOption.backgroundBorder" :src="main.activeOption.backgroundBorder" alt="" width="100%" />
                        <el-input v-model="main.activeOption.backgroundBorder">
                            <div @click="main.handleOpenImg('activeOption.backgroundBorder','border')" slot="append">
